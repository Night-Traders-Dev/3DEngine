...
proc generate_game_script(world, scene_name, settings):
    ...
    if has_voxel_worlds:
        ...
        push(L, "        let draws = voxel_visible_draws(vw, player[" + q + "position" + q + "][0] - t[" + q + "position" + q + "][0], player[" + q + "position" + q + "][1] - t[" + q + "position" + q + "][1], player[" + q + "position" + q + "][2] - t[" + q + "position" + q + "][2], 1)")
        push(L, "        let di = 0")
        push(L, "        while di < len(draws):")
