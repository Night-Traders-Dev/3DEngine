...
check("sand surface is bright and warm", sand_surface["albedo"][0] > 0.8 and sand_surface["albedo"][1] > sand_surface["albedo"][2])
...
check("generated world no longer paints large azure clay biomes", _count_block(colorful_generated, 8) == 0)
